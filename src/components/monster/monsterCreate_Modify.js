...
*/
  ...
  const submitBtn = (event) => {
    ...
    monster.damage_vulnerabilities = monster.damage_vulnerabilities.replace(
      /'/g,
      "''"
    );
    ...
    monster.condition_immunities = monster.condition_immunities.replace(
      /'/g,
      "''"
    );
    ...
    return (
      <div id="deleteMonster">
        <div className="infoBox">
          ...
          <h2>
            Enter current password below if you are sure you want to delete.
          </h2>
            ...
            <form>
              <div className="inputGrouping top">
                ...
                <div className="inputField small">
                  ...
                  >
                    <option selected disabled value={monster.size} hidden>
                      {monster.size}
                    </option>
                ...
                <div id="speedInput">
                  <form>
                    <div className="inputGrouping">
                      ...
                      <div className="inputField xsmall">
                        {theUser && arrayID.speed === 0 && (
                          <Button
                            variant="success"
                            className="profileEditOptions"
                            onClick={(event) => submitArray(event, "speed")}
                          >
                            Add
                          </Button>
                        )}
                      ...
                      <div className="inputField xsmall">
                        {theUser && (
                          <Button
                            variant="danger"
                            className="profileEditOptions"
                            onClick={(event) => deleteArray(event, "speed")}
                          >
                            Delete
                          </Button>
                        )}
                ...
                <div id="skillInput">
                  <form>
                    <div className="inputGrouping">
                      ...
                      <div className="inputField xsmall">
                        {theUser && arrayID.skills === 0 && (
                          <Button
                            variant="success"
                            className="profileEditOptions"
                            onClick={(event) => submitArray(event, "skills")}
                          >
                            Add
                          </Button>
                        )}
                      ...
                      <div className="inputField xsmall">
                        {theUser && (
                          <Button
                            variant="danger"
                            className="profileEditOptions"
                            onClick={(event) => deleteArray(event, "skills")}
                          >
                            Delete
                          </Button>
                        )}
                ...
                <div id="special_abilitiesInput">
                  <form>
                    <div className="inputGrouping">
                      ...
                      <div className="inputField xsmall">
                        {theUser && arrayID.special_abilities === 0 && (
                          <Button
                            variant="success"
                            className="profileEditOptions"
                            onClick={(event) =>
                              submitArray(event, "special_abilities")
                            }
                          >
                            Add
                          </Button>
                      ...
                      <div className="inputField xsmall">
                        {theUser && (
                          <Button
                            ...
                            className="profileEditOptions"
                            onClick={(event) =>
                              deleteArray(event, "special_abilities")
                            }
                          >
                            Delete
                          </Button>
                ...
                <div id="legendary_actionsInput">
                  <form>
                    <div className="inputGrouping">
                      ...
                      <div className="inputField xsmall">
                        {theUser && arrayID.legendary_actions === 0 && (
                          <Button
                            variant="success"
                            className="profileEditOptions"
                            onClick={(event) =>
                              submitArray(event, "legendary_actions")
                            }
                          >
                            Add
                          </Button>
                      ...
                      <div className="inputField xsmall">
                        {theUser && (
                          <Button
                            ...
                            className="profileEditOptions"
                            onClick={(event) =>
                              deleteArray(event, "legendary_actions")
                            }
                          >
                            Delete
                          </Button>
                ...
                <div id="actionsInput">
                  <form>
                    <div className="inputGrouping">
                      ...
                      <div className="inputField xsmall">
                        {theUser && arrayID.actions === 0 && (
                          <Button
                            variant="success"
                            className="profileEditOptions"
                            onClick={(event) => submitArray(event, "actions")}
                          >
                            Add
                          </Button>
                        )}
                      ...
                      <div className="inputField xsmall">
                        {theUser && (
                          <Button
                            variant="danger"
                            className="profileEditOptions"
                            onClick={(event) => deleteArray(event, "actions")}
                          >
                            Delete
                          </Button>
                        )}
            ...
            {theUser && !newID && (
              <div>
                ...
                <Button
                  variant="danger"
                  className="profileEditOptions"
                  onClick={() => setDeleteMode((x) => ({ ...x, active: true }))}
                >
                  Delete
                </Button>
              </div>

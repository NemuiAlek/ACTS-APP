...
const getMonster = () =>{
    axios
    .get("http://https://acts-api-production.up.railway.app/monster/" + params.id, {
    })
    .then((response) => {
...
const submitBtn = (event) => {
    ...
    ///*
    axios
    .post("http://https://acts-api-production.up.railway.app/monster/create-update/" + params.id, 
    {
        userID: theUser.id,
        data: monster
    })
...
const deleteMonster = () =>{
    ...
    axios
    .post("http://https://acts-api-production.up.railway.app/monster/delete/" + params.id, {
        id:theUser.id,
...
const submitArray = (event, array) => {
    event.preventDefault();
    axios
    .post("http://https://acts-api-production.up.railway.app/monster/create-update-array/" + arrayID[array].toString(), 
    {
        monsterID:params.id,
        arrayName: array,
...
const deleteArray = (event, array) => {
    event.preventDefault();
    axios
    .post("http://https://acts-api-production.up.railway.app/monster/delete-array/" + arrayID[array].toString(), 
    {
        monsterID:params.id,
        arrayName: array
    })

    ...
    <div id="monsterPage">
      <div id="monsterOptions">
        <button id="backBtn" onClick={backBtn}>
          Back to Monster Dictionary
        </button>
        {theUser !== undefined &&
          !isNaN(params.id) &&
          theUser.id === monster.CreatedBy && (
            <button id="updateBtn" onClick={updateBtn}>
              Update
            </button>
          )}
      </div>
            ...
            <div className="property-line last">
              ...
              {!isNaN(params.id) &&
                ...
                monster.speed.map((array) => (
                  <p key={array.id}>
                    {array.name === "walk" ? "" : array.name} {array.modifier}
                    ft.,{" "}
                  </p>
                ))}
            </div>

...
*/
  ...
  const submitUpdateUser = (event) => {
    ...
    if (userInfo.newPass === "" && userInfo.currentPass !== "") {
      ...
      !validation("Pass", userInfo.newPass) &&
      userInfo.newPass !== ""
    ) {
      validate((x) => ({
        ...x,
...
*/
  ...
  useEffect(() => {
    if (
      ...
      errorMessage.validCurrentPass === true &&
      errorMessage.validNewPass === true &&
      ...
      axios
        ...
        .catch((err) => {
          ...
          if (
            ...
            errorMessage ===
            "Username " + userInfo.username + " is already registered"
          ) {
        ...
        <form className="profileForm">
          ...
          {editMode && !deleteMode && (
            <div className="editMode">
              ...
              {errorMessage.validCurrentPass !== false &&
                errorMessage.validCurrentPass !== true && (
              ...
              <br />
              {errorMessage.validNewPass !== false &&
                errorMessage.validNewPass !== true && (
              ...
              <button className="profileEditOptions" onClick={submitUpdateUser}>
                Update
              </button>
              <button className="profileEditOptions" onClick={enableDelete}>
                Delete Account
              </button>
            </div>
          )}
